...
export const BalanceCard = styled.View<{color?: string}>`
  background-color: ${({theme, color}) => color || theme.colors.emperor};
...
export const BalanceCardPercentageText = styled.Text<{color?: string}>`
  color: ${({theme, color}) => color ? color : theme.colors.saffron};
  font-family: ${({theme}) => theme.fonts.SEMIBOLD};
  font-size: ${hpx('2%')};
`;

export const BalanceCardPercentage = styled.View`
  position: absolute;
  top: ${hpx('2%')};
  right: ${wpx('4%')};
  align-items: center;
...
export const BalanceAddButton = styled.TouchableOpacity<{color?: string}>`
  position: absolute;
  bottom: ${hpx('0%')};
  right: ${wpx('0%')};
  align-items: center;
  ...
  background-color: ${({theme, color}) => color ? color : theme.colors.saffron};
